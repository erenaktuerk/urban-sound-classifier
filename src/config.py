...
INPUT_SHAPE = (16000, 1)  # Example for 1D audio data (e.g., 16 kHz, 1 channel)

# Feature extraction parameters
N_MFCC = 13  # Number of MFCC features to extract from each audio file

# Class labels (optional if there are predefined classes, otherwise labels will be dynamically extracted from the folder names)
LABELS = [
